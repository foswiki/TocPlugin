...
my $wif = Foswiki::Plugins::TocPlugin::test::FakeWikiIF->getInterface("Test", $l1btext);

my ($root, $mess) = Foswiki::Plugins::TocPlugin::TopLevelSection::createTOC("Test", $wif);
...
\t* $l1btext
");
($root, $mess) = Foswiki::Plugins::TocPlugin::TopLevelSection::createTOC("Test", $wif);
ASSERT($mess eq
...
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($l1text, "%SECTION1% $l2tagtext");
my $l3tagtext = "Tagged LevelThree Section";
my $l3tagtexp = "Tagged <nop>LevelThree Section";
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($l2text, "%SECTION1% $l3tagtext");
my $l4tagtext = "Tagged LevelFourSection";
my $l4tagtexp = "Tagged <nop>LevelFourSection";
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($l3text, "%SECTION1% $l4tagtext");
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($l1btext, "%SECTION0% $l1btexp");
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($l2btext, "%SECTION0% $l2btexp");

($root, $mess) = Foswiki::Plugins::TocPlugin::TopLevelSection::createTOC("Test", $wif);
die $mess unless $root;
ASSERT($root->processTOCTag(Foswiki::Plugins::TocPlugin::Attrs->new("")) eq
                "$DIV
...
$LU$VID");
ASSERT($root->processTOCTag(Foswiki::Plugins::TocPlugin::Attrs->new("topic=$l1text")) eq
                "$DIV
$UL$LI$JS$l1text${JE}1. $l1texp$AE$UL
$LI$JS$l2text${JE}1.1. $l2texp$AE$UL
$LI$JS$l3text${JE}1.1.1. $l3texp$AE$UL
...
ASSERT($root->processREFTABLETag(Foswiki::Plugins::TocPlugin::Attrs->new("")) eq
                "${ERF}Bad type in REFTABLE$FRE");
ASSERT($root->processREFTABLETag(Foswiki::Plugins::TocPlugin::Attrs->new("type=fred")) eq
