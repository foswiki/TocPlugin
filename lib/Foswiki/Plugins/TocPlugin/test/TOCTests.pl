...
my $topic1 = "TopLevel";
my $topic2 = "ReferToMe";
my $wif = Foswiki::Plugins::TocPlugin::test::FakeWikiIF->getInterface("Test", $topic1);

Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic("WebOrder","\t* $topic1\n\t* $topic2");
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($topic1, "Blah");
Foswiki::Plugins::TocPlugin::test::FakeWikiIF::writeTopic($topic2, "%SECTION1{name=refme}% Refer to me");
...
$mess = Foswiki::Plugins::TocPlugin::TOC::processTopic($wif, "Test", $topic1, $text);
